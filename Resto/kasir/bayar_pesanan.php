...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["kode_pembayaran"]) || empty($_POST["harga_pembayaran"]) || empty($_POST['metode_pembayaran'])) {
    ...
    $id_pembayaran = $_POST['id_pem$id_pembayaran'];

    $status_pesanan = $_GET['status_pesanan'];

    //Insert Captured information to a database table
    $postQuery = "INSERT INTO pembayaran (id_pembayaran, kode_pembayaran, kode_pesanan, id_pelanggan, harga_pembayaran, metode_pembayaran) VALUES(?,?,?,?,?,?)";
    ...
    $rc = $postStmt->bind_param('ssssss', $id_pembayaran, $kode_pembayaran, $kode_pesanan, $id_pelanggan, $harga_pembayaran, $metode_pembayaran);
    ...
    if ($upStmt && $postStmt) {
      $success = "Sudah Bayar" && header("refresh:1; url=struk.php");
    } else {
              ...
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="id_pem$id_pembayaran" readonly value="<?php echo $payid;?>" class="form-control">
                  </div>
                  <div class="col-md-6">
