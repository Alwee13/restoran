    ...
    <div class="container-fluid">
          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="avatar avatar-sm rounded-circle">
                <img alt='Image placeholder' src='../admin/assets/img/brand/logo.png'>
              </span>
            </div>
          </a>
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="ubah_profil.php">
              <i class="fas fa-users text-primary"></i> Profil Saya
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pesanan.php">
              <i class="ni ni-cart text-primary"></i>Buat Pesanan
            </a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="laporan_pesanan.php">
              <i class="fas fa-shopping-basket"></i> Pesanan Saya
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="laporan_pembayaran.php">
              <i class="fas fa-funnel-dollar"></i> Pembayaran Saya
            </a>
          </li>
        </ul>
        <hr class="my-3">
