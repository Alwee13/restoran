                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    $ret = "SELECT * FROM  pesanan WHERE status_pesanan ='' AND id_pelanggan = '$id_pelanggan'  ORDER BY `pesanan`.`created_at` DESC  ";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="bayar_pesanan.php?kode_pesanan=<?php echo $order->kode_pesanan;?>&id_pelanggan=<?php echo $order->id_pelanggan;?>&status_pesanan=Sudah Bayar">
