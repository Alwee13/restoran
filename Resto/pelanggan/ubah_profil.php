...
if (isset($_POST['ChangeProfile'])) {
  ...
  if (empty($_POST["no_telp"]) || empty($_POST["nama_pelanggan"]) || empty($_POST['email_pelanggan'])) {
    ...
    //bind paramaters
    $rc = $postStmt->bind_param('sssss', $nama_pelanggan, $no_telp, $email_pelanggan, $password_pelanggan, $id_pelanggan);
    $postStmt->execute();
    //declare a varible which will be passed to alert function
    if ($postStmt) {
      $success = "Profil Diperbarui" && header("refresh:1; url=dashboard.php");
    } else {
...
if (isset($_POST['changePassword'])) {
    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['password_pelanggan']) {
                ...
                //Insert Captured information to a database table
                $query = "UPDATE pelanggan SET  password_pelanggan =? WHERE id_pelanggan =?";
                $stmt = $mysqli->prepare($query);
                //bind paramaters
                $rc = $stmt->bind_param('si', $new_password, $id_pelanggan);
                $stmt->execute();
...
<body>
    ...
    <div class="main-content">
        ...
        $ret = "SELECT * FROM  pelanggan  WHERE id_pelanggan = '$id_pelanggan'";
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            <h1 class="display-2 text-white">Halo <?php echo $customer->nama_pelanggan; ?></h1>
                        ...
                        <div class="card card-profile shadow">
                            ...
                            <div class="card-body pt-0 pt-md-4">
                                ...
                                <div class="text-center">
                                    <h3>
                                        <?php echo $customer->nama_pelanggan; ?></span>
                                    </h3>
                                    <div class="h5 font-weight-300">
                                        <i class="fas fa-envelope mr-2"></i><?php echo $customer->email_pelanggan; ?>
                                    </div>
                                    <div class="h5 font-weight-300">
                                        <i class="fas fa-phone mr-2"></i><?php echo $customer->no_telp; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama_pelanggan" value="<?php echo $customer->nama_pelanggan; ?>" id="input-username" class="form-control form-control-alternative" ">
                                                </div>
                                            </div>
                                            <div class=" col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">Nomor Telepon</label>
                                                    <input type="text" id="input-email" value="<?php echo $customer->no_telp; ?>" name="customer_phone" class="form-control form-control-alternative">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-email">Alamat Email</label>
                                                    <input type="email" id="input-email" value="<?php echo $customer->email_pelanggan; ?>" name="email_pelanggan" class="form-control form-control-alternative">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
