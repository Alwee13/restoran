            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  $ret = "SELECT * FROM  pesanan WHERE id_pelanggan = '$id_pelanggan' ORDER BY `pesanan`.`created_at` DESC LIMIT 10 ";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM   pembayaran WHERE id_pelanggan ='$id_pelanggan'   ORDER BY `pembayaran`.`created_at` DESC LIMIT 10 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
